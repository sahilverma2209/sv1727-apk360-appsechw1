...
class MySpellChecker extends Component {
  ...
  async fetchRecent(){
    ...
    const request = await axios.get(`https://cors-anywhere.herokuapp.com/https://sv1727-apk360-spellcheck.herokuapp.com/userSpells/${email}`)
    var data = request.data
    var arr = []
    console.log(data)
    data.userSpells.spells.forEach(item => arr.push(<li>{item}</li>))
  ...
  async spellCheck(){
    ...
    preview.innerHTML = this.state.spellcheckText
        ...
        <div className="row1">
          ...
          <div className="data-error">
              <div className="file-content">Original file contents:&nbsp;&nbsp;
                <div id="orignial-file-contents" dangerouslySetInnerHTML={{ __html: this.state.spellcheckText }}></div>
              </div>
